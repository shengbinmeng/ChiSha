...
public class ChiShaActivity extends SherlockFragmentActivity {
    TabHost mTabHost;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("choose").setIndicator("吃啥",res.getDrawable(android.R.drawable.ic_popup_reminder)),
                ChooseActivity.ChooseFragment.class, null);
